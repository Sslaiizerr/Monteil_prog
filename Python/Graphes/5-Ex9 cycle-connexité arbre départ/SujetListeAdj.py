...
class ListeAdj:
    ...
    def __init__(self, nbSommets, orientation):
        assert nbSommets >= 1, "le nombre de sommet de liste d'Adjacence supérieur à 1"
        self._listA = []
        self._orientation = orientation # True si arbre orienté
...
# --------------------------------------------------
    ...
    def ajoutArete(self, i, j):
        ...
        if self._orientation == False :
            self._listA[j].append(i) # ligne active si arbre non orienté
