...
if __name__ == '__main__':
    ...
    # g1.draw("g1")
    assert distG2 == [0, 2, 3, 2, 1] , "Le vecteur des distances n'est pas correctement rempli"
    assert pereG2 == [1, 5, 4, 5, 1] , "Le vecteur des pères n'est pas correctement rempli"
