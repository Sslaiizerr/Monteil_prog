...
class Arbre:
    ...
    def _parcoursInf(self, l):
        if self._gauche:
            self._gauche._parcoursInf(l)
        l.append(self._racine)
        if self._droit:
            self._droit._parcoursInf(l)
        return l
    ...
    def _parcoursPost(self, l):
        if self._gauche:
            self._gauche._parcoursPost(l)
        if self._droit:
            self._droit._parcoursPost(l)
        l.append(self._racine)
        return l
    ...
    def rechercher(self, valeur):
        ...
        if valeur > self._racine:
            if self._droit:
                return self._droit.rechercher(valeur)
            else:
                return False
        return valeur == self._racine


if __name__ == '__main__':
    a = Arbre.construireArbre()
    a._draw()

    print("Parcours Préfixe : ", a.parcoursPre())
    print("Parcours Infixe : ", a.parcoursInf())
    print("Parcours Postfixe : ", a.parcoursPost())

    print("rechercher(15) ", a.rechercher(15))
    print("rechercher(19) ", a.rechercher(19))
    print("rechercher(23) ", a.rechercher(23))

    print("la hateur du noeud 13 est : ", a.hauteurNoeud(13))
    print("la hateur du noeud 8 est : ", a.hauteurNoeud(8))

    print("la hateur totale de l'arbre est : ", a.hauteur())

    print("le nombre minimum d'un noeud de cet arbre est : ", a.minimum())
    print("le nombre maximum d'un noeud de cet arbre est : ", a.maximum())
